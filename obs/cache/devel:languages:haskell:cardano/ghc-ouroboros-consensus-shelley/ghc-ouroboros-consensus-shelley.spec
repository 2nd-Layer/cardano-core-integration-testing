#
# spec file for package ghc-ouroboros-consensus-shelley
#
...
%global pkg_name ouroboros-consensus-shelley
Name:           ghc-%{pkg_name}
Version:        0.1.0.0
Release:        0
Summary:        Shelley ledger integration in the Ouroboros consensus layer
License:        Apache-2.0
URL:            https://github.com/input-output-hk/ouroboros-network/tree/master/ouroboros-consensus-shelley
