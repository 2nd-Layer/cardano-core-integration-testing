#
# spec file for package ghc-cardano-crypto-praos
#
...
%global pkg_name cardano-crypto-praos
Name:           ghc-%{pkg_name}
Version:        2.0.0
Release:        0
Summary:        Crypto primitives from libsodium
License:        Apache-2.0
...
%build
%define cabal_configure_options -f -external-libsodium-vrf
%ghc_lib_build
